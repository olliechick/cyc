...
public class CSVLoader {
    ...
    * @throws IOException If an IO error occurs.
    ...
    /**
     * Calls the load CSV methods and populates an array list with a set of biketrip objects
    ...
    public static ArrayList<DataPoint> populateWifiHotspots(String filename){
        ...
        try {
            ArrayList<CSVRecord> hotspots = loadCSV(filename);
            for(CSVRecord record : hotspots){
    ...
    * Just used for testing
     * If you use a file for testing please include it in the git artifacts
    * @author Ollie Chick
     */
    public static void main(String[] args) {
        //String filename = "bikeTrips.csv";
